...
INSERT INTO `delivery` (`Delivery_ID`, `Order_ID`, `Shipping_Address`, `Delivery_Status`, `Tracking_Number`, `Recipient_Name`, `Shipping_Date`) VALUES
('DLV0001', 'ORD0006', 'B-8-12, Ivory Heights Condominium, Jalan Dato Ismail Hashim, 11900 Bayan Lepas, Pulau Pinang, Malaysia', 'In Transit', 'TRK20250509131654694', '', '0000-00-00 00:00:00'),
('DLV0002', 'ORD0005', 'B-8-12, Ivory Heights Condominium, Jalan Dato Ismail Hashim, 11900 Bayan Lepas, Pulau Pinang, Malaysia', 'In Transit', 'TRK20250509132851658', 'John Doe', '0000-00-00 00:00:00');
...
('ORD0002', 'U00001', 6457.70, 'Pending', 0.00, '1', 0.00, 6457.70, '2025-05-09 03:37:46'),
('ORD0003', 'U00001', 6079.75, 'Pending', 0.00, '1', 0.00, 6079.75, '2025-05-09 03:46:06'),
('ORD0004', 'U00001', 6079.75, 'Pending', 0.00, '1', 0.00, 6079.75, '2025-05-09 03:47:59'),
('ORD0005', 'U00001', 8837.80, 'Shipped', 0.00, '1', 0.00, 8837.80, '2025-05-09 05:25:11'),
('ORD0006', 'U00001', 6207.80, 'Shipped', 0.00, '1', 0.00, 6207.80, '2025-05-09 05:24:58'),
('ORD0007', 'U00001', 6207.80, 'Processing', 0.00, '1', 0.00, 6207.80, '2025-05-09 05:04:31');
...
('CANCEL0002', 'ORD0007', 'Rejected', 'asdasd', '2025-05-09 13:37:38', 'No'),
('CANCEL0003', 'ORD0007', 'Rejected', 'aSSASA', '2025-05-09 13:37:47', 'No');
...
('ORDT0004', '0', 'PCBU', 1, 6457.70, NULL),
('ORDT0005', '0', 'PCBU', 1, 6079.75, NULL),
('ORDT0006', '0', 'PCBU', 1, 6079.75, NULL),
('ORDT0007', 'ORD0005', 'PCBU', 1, 8837.80, NULL),
('ORDT0008', 'ORD0006', 'PCBU', 1, 6207.80, 'Custom PC Build Components:\n- Intel Core i5-13600K (Intel) ($1,550.95)\n- Arctic Liquid Freezer II 240 (Corsair) ($449.00)\n- MSI B650M Mortar WiFi (MSI) ($799.00)\n- ASUS Dual Radeon RX 7600 (AMD) ($1,389.00)\n- Corsair Vengeance 32GB DDR5 (Corsair) ($610.95)\n- Crucial MX500 1TB SSD (MSI) ($329.95)\n- Corsair RM850x PSU (Corsair) ($699.95)\n- Corsair 4000D Airflow (Corsair) ($379.00)\n'),
('ORDT0009', 'ORD0007', 'PCBU', 1, 6207.80, 'Custom PC Build Components:\n- Intel Core i5-13600K (Intel) ($1,550.95)\n- Arctic Liquid Freezer II 240 (Corsair) ($449.00)\n- MSI B650M Mortar WiFi (MSI) ($799.00)\n- ASUS Dual Radeon RX 7600 (AMD) ($1,389.00)\n- Corsair Vengeance 32GB DDR5 (Corsair) ($610.95)\n- Crucial MX500 1TB SSD (MSI) ($329.95)\n- Corsair RM850x PSU (Corsair) ($699.95)\n- Corsair 4000D Airflow (Corsair) ($379.00)\n');
