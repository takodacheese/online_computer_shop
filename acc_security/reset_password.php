            ...
            if ($resetRequest) {
                ...
                if ($user) {
                    ...
                    $updateStmt = $conn->prepare("
                        ...
                        WHERE user_id = ?
                    ");
                    $updateStmt->execute([$password, $resetRequest['user_id']]);
...
.resetpassword {
    ...
    color: white;
    box-shadow: 
        0 -3px 3px rgba(73, 0, 255, 10),
        0 3px 3px rgba(73, 0, 255, 10),
        -3px 0 3px rgba(73, 0, 255, 10),
        3px 0 3px rgba(73, 0, 255, 10);
}
